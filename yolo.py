...
class Ui_MainWindow(object):
    ...
    def detect(self):
        ...
        if flag == 512:
            ...
            '''
dd                                                                                  
            os.system(f'./darknet/darknet detector demo darknet/data/vant_dataset.data darknet/cfg/yolo-obj.cfg {weight} {video_pre} -out_filename detect{cont}.avi -dont_show -ext_output > detect{cont}.txt &')#teste / funciona assim
